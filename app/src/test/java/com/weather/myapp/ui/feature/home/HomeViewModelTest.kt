...
import com.weather.myapp.resource.TestLocationLiveData
import io.mockk.*
...
class HomeViewModelTest {
    ...
    private val mockWeatherHistory: com.weather.myapp.data.db.entities.WeatherHistory = mockk()
...
//            homeViewModel.weatherResponseState.value.shouldBe( mockWeatherResponse)
    ...
    fun `getSavedWeatherHistory should update savedWeatherHistoryList`() =
        runBlockingTest {
            // Arrange
            val mockWeatherHistoryList: List<com.weather.myapp.data.db.entities.WeatherHistory> = listOf(mockWeatherHistory)
